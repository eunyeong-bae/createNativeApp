...
import { View, Dimensions, SafeAreaView, Text, Image, ScrollView, FlatList} from 'react-native';
...
const MyDoc = ( props : any) => {
    const { sortMenuState, setSortMenu, targetFullPathState, setTargetFullPath} = useContext(CommonContext);
    ...
    useEffect(() => { // unmount, context Api 초기화
        ...
        else if(sortItem !== sortMenuState.selectedValue.sortItem || fileTypes !== sortMenuState.selectedValue.fileTypes ||  sortOrder !== sortMenuState.selectedValue.sortOrder) {
